...
enum TransitRealtime_TrackDirection: SwiftProtobuf.Enum {
...
extension TransitRealtime_TrackDirection: CaseIterable {
...
struct TransitRealtime_Alert: SwiftProtobuf.ExtensibleMessage {
  ...
  /// NEW
  enum SeverityLevel: SwiftProtobuf.Enum {
    typealias RawValue = Int
...
extension TransitRealtime_Alert.SeverityLevel: CaseIterable {
  // Support synthesized by the compiler.
}
...
struct TransitRealtime_UpdateBundle {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// NEW 
struct TransitRealtime_CarriageDescriptor: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum ToiletStatus: SwiftProtobuf.Enum {
    typealias RawValue = Int
    case none // = 0
    case normal // = 1
    case accessible // = 2
...
extension TransitRealtime_CarriageDescriptor.OccupancyStatus: CaseIterable {
  // Support synthesized by the compiler.
}

extension TransitRealtime_CarriageDescriptor.ToiletStatus: CaseIterable {
  // Support synthesized by the compiler.
}
...
// MARK: - Extension support defined in gtfs-realtime.proto.
...
extension TransitRealtime_VehiclePosition {
  ...
  /// Returns true if extension `TransitRealtime_Extensions_consist`
  /// has been explicitly set.
  var hasTransitRealtime_consist: Bool {
    return hasExtensionValue(ext: TransitRealtime_Extensions_consist)
  }
  /// Clears the value of extension `TransitRealtime_Extensions_consist`.
  /// Subsequent reads from it will return its default value.
  mutating func clearTransitRealtime_consist() {
    clearExtensionValue(ext: TransitRealtime_Extensions_consist)
  }

}

// MARK: - File's ExtensionMap: TransitRealtime_Gtfs_u45Realtime_Extensions

/// A `SwiftProtobuf.SimpleExtensionMap` that includes all of the extensions defined by
/// this .proto file. It can be used any place an `SwiftProtobuf.ExtensionMap` is needed
/// in parsing, or it can be combined with other `SwiftProtobuf.SimpleExtensionMap`s to create
/// a larger `SwiftProtobuf.SimpleExtensionMap`.
let TransitRealtime_Gtfs_u45Realtime_Extensions: SwiftProtobuf.SimpleExtensionMap = [
