...
final class StationsByNameSectionController: ListSectionController {
...
extension StationsByNameSectionController: ASSectionController {
  func nodeBlockForItem(at index: Int) -> ASCellNodeBlock {
    return {
      StationByNameCellNode(station: self.object)
    }
  }
...
extension StationsByNameSectionController: ListSupplementaryViewSource {
...
extension StationsByNameSectionController: ASSupplementaryNodeSource {
