...
final class AddTripOriginVC: ASViewController {
  ...
  private class DataSource: UITableViewDiffableDataSource<SortedStations, Station> {
    weak var parent: AddTripOriginVC! = nil
...
extension AddTripOriginVC: UITableViewDelegate {
...
extension AddTripOriginVC: UISearchBarDelegate {
